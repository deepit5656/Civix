    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-b border-green-100 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
          <BackButton />
          <div className="text-center flex-1 pr-0 md:pr-16">
            <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-600 dark:from-green-600 dark:to-emerald-700 rounded-2xl shadow-lg mb-2">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
            </div>
            <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-green-700 to-emerald-700 dark:from-green-400 dark:to-emerald-400 bg-clip-text text-transparent">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <SectionGuide
          title="National Unified District Information System for Education (UDISE+)"
          purpose="This section presents official education and school infrastructure statistics across Indian States & UTs, detailing institutional counts, student facilities, and educational reach."
          howToUse={[
            "Explore state and national education metric cards and tables.",
            "Compare educational resources across primary, secondary, and senior secondary schools.",
            "Search or filter by state name in the data table below.",
          ]}
          dataSource="Department of School Education & Literacy / Ministry of Education (UDISE+ Portal)"
          sourceUrl="https://udiseplus.gov.in/"
          scope="State & District Level (All India Education System)"
        />
